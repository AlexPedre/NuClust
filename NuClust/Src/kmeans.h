...
#  define KMEANS_THR_MAX        24
//#  define KMEANS_THR_THRESHOLD  250000
#  define KMEANS_THR_THRESHOLD  10000
#endif
...
*/
typedef HD_FLOAT (*kmeans_distance_method) (const HD_POINTER a, const HD_POINTER b);
...
*/
typedef void (*kmeans_centroid_method) (const HD_POINTER *objs, const HD_LONG *clusters, HD_SIZE num_objs, HD_LONG cluster, HD_POINTER centroid);

#  ifdef KMEANS_THREADED
typedef struct {
  HD_MUTEX                update_means_k_mutex;
  HD_THREAD *             Thread;
  HD_ULONG                NumThreadK;
  HD_ULONG                NumThreadObj;
  HD_ULONG *              update_means_k;
  struct kmeans_config *  ConfigVect;
} kmeans_thread_data;
#  endif
...
#  endif
  ...
  /* library default */
  HD_ULONG max_iterations;

  /* Iteration counter */
  HD_ULONG total_iterations;
