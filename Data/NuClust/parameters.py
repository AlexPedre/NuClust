...
try:
  import {COMMONPART} as Nuc
except:
  print("ERROR: Can't find {COMMONPART}.py Python script")
  sys.exit(2)
# End try

#**** Global parameters ****

Nuc.FilePrefix            = '{FILEPREFIX}'     # File name prefix
Nuc.PlatformName          = 'CUDA'             # Platform name
Nuc.PdbFileName           = '{PDBFILE}'        # PDB file name
